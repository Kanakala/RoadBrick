...
class LoginForm(auth.forms.AuthenticationForm):
	...
	email = forms.EmailField(label=_("Email"), widget=forms.EmailInput(attrs={'class': 'span2','placeholder': 'Email'}))
	password = forms.CharField(label=_("Password"), widget=forms.PasswordInput(attrs={'class': 'span2','placeholder':'Password'}))
	CHOICES= (('Truck', 'Truck'),('Company', 'Company'),)
	Label = forms.ChoiceField(choices=CHOICES, label='Label', widget=forms.RadioSelect())
